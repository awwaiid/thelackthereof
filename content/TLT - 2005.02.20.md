...
Or better yet some feedback. What I really need is someone ELSE to actually use the thing. But the likelihood of anyone else using it in its convoluted state is pretty low. I suppose I should focus on how well it works for me :)

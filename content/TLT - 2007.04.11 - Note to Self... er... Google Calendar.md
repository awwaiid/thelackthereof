...
A few years ago, while doing some contract work, I created a simple yet effective way to monitor my time. The idea was taken from some other command line junkie, but I simplified it a bit. I dropped a command called "L" into my ~/bin directory that looks like this:

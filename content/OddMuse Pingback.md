...
I would appreciate it if people could link to this page in a pingback-enabled post of some kind so that I can make sure it works. The only way I've tested it is with [http://software.hixie.ch/utilities/cgi/pingback-proxy/client.html this client], which has worked swimmingly.

---
title: .vimrc
createdAt: 2017-04-10T10:35-04:00
...
" Vimwiki
" --------------------
let g:vimwiki_list = [{ 'path': '~/notes/', 'path_html': '~/notes/html/', 'maxhi': 1, 'auto_toc': 1 }]
...
function WikiGet()
  r !wikiget 'https://thelackthereof.org/%:t:r'
endfunction

funciton WikiPost()
  !cat '%' | wikiput -u awwaiid -a FISHIES 'https://thelackthereof.org/%:t:r'
endfunction
